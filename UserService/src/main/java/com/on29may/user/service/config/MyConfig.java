package com.on29may.user.service.config;
...
import com.on29may.user.service.config.interceptors.RestTemplateInterceptor;
...
public class MyConfig {
	...
	// CREATING THE BEAN OF OAuth2 Authorized Client Manager
	@Bean
